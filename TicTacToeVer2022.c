...
void welcome()
{
	...
	printf("\t\t\t***********************************************************\n");
	printf("\t\t\t*                                                         *\n");
	printf("\t\t\t*               WELCOME TO MORPION GAME                   *\n");
	printf("\t\t\t*            Developed with C By Med Rami                 *\n");
	printf("\t\t\t*                       ENJOY :)                          *\n");
	printf("\t\t\t*                                                         *\n");
	printf("\t\t\t***********************************************************\n");
	printf("\n\n");	
...
char** initBoard(){
    ...
    int i,j;
    for(i=0;i<3;i++) board[i] = (char*) malloc(3*sizeof(char));
    for(i=0;i<3;i++){
        for(j=0;j<3;j++){
            board[i][j] = (3 * i + j + 1) + '0';
        }
